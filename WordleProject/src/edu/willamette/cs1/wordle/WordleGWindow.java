...
/** The rainbow colors array once word is found! (UNIFINISHED) */
    public static final Color[] RAINBOW_COLORS = {new Color (209, 59, 59), new Color (245, 172, 2), new Color (242, 222, 5), new Color (73, 204, 82), new Color (15, 118, 214)};
/**
